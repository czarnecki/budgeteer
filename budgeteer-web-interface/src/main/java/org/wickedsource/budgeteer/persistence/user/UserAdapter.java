...
public class UserAdapter implements GetUsersInProjectPort,
        ...
        GetVerificationTokenExpirationDate {
    ...
    @Override
    public void createForgottenPasswordToken(long userId, String token, LocalDateTime expirationDate) {
    ...
    public Optional<User> getUserByEmail(String mail) {
        return Optional.ofNullable(userRepository.findByMail(mail))
                .map(userMapper::mapToDomain);
    }
