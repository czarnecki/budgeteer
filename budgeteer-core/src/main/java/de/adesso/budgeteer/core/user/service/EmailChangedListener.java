...
public class EmailChangedListener implements ApplicationListener<OnEmailChangedEvent>, ResendVerificationTokenUseCase {
    ...
    private final DeleteVerificationTokenByUserIdPort deleteVerificationTokenByUserIdPort;
    ...
    @Override
    public void resendVerificationToken(long userId) throws EmailAlreadyVerifiedException {
    ...
    private void sendVerificationToken(long userId, String name, String email) {
        ...
        deleteVerificationTokenByUserIdPort.deleteVerificationTokenByUserId(userId);
